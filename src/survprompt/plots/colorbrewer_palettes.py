"""ColorBrewer palette specifications.

Derived from the ColorBrewer JSON export
...
The underlying color specifications are by Cynthia A. Brewer, Department of
Geography, Pennsylvania State University (https://colorbrewer2.org/).

This file has been modified from the original: the JSON export has been
transcribed into a Python dictionary.
"""
...
# Example usage:
#
# from colorbrewer_palettes import colorbrewer
#
# # Access a 5-color OrRd palette
# my_colors = colorbrewer["OrRd"]["5"]
# print(my_colors)  # -> ["rgb(254,240,217)", "rgb(253,204,138)", "rgb(252,141,89)", "rgb(227,74,51)", "rgb(179,0,0)"]
