"""Survival-analysis utilities adapted from the synthcity codebase.

Portions of this file are derived from synthcity
(https://github.com/vanderschaarlab/synthcity), licensed under the
